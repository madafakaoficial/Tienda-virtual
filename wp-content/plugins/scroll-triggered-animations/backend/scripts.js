...
jQuery('.colour-changing-background').css({'background': color});
...
//CHECKBOXES
var styledCheckbox = '<div class="styled-checkbox"><div class="check"></div></div>';

jQuery('input[type="checkbox"]').each(function(){

jQuery(this).parents('td').append(styledCheckbox);

if(jQuery(this).attr('checked')){

jQuery(this).parents('td').find('.styled-checkbox').addClass('checked');

}
});//each

jQuery('.styled-checkbox').on('click', function(){

if(jQuery(this).hasClass('checked')){
jQuery(this).removeClass('checked');
jQuery(this).parent('td').find('input[type="checkbox"]').removeAttr('checked');

}else{
jQuery(this).addClass('checked');
jQuery(this).parent('td').find('input[type="checkbox"]').attr('checked', 'checked');
}
...
jQuery('.premium-feature').append('<div class="premium-upgrade"><div class="premium-text">Only available with premium</div><a href="https://www.toastplugins.co.uk/premium/scroll-triggered-animations-premium/" class="button button-primary" target="_blank">Get premium now!</a></div>')
